...
export default function AddAdmin({ AddFunction }) {
                    ...
                    <form noValidate onSubmit={add}>
                      ...
                      <div className="flex justify-end items-center">
                        <button
                          type="button"
                          onClick={closeModal}
                          className="w-24 border-gray-500 text-gray-500 border-[2px] m-3 rounded-md duration-500 hover:bg-gray-500 hover:text-white"
                        >
                          Cancel
                        </button>
                        <button className="w-24 border-blue-500 text-blue-500 border-[2px] m-3 rounded-md duration-500 hover:bg-blue-500 hover:text-white">
                          Add Admin
                        </button>
                      </div>
                    </form>
