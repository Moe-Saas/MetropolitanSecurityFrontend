...
export default function EditAlert({UpdateFunction,data,id}) {
                ...
                <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    ...
                    <div className='m-1'>
                        ...
                        <DatePicker
                        timeIntervals={1}
                        selected={state&&state.date && new Date(state.date)} onChange={(value) => {setState((prevState) => ({ ...prevState, date: value}))}}  showTimeSelect className="w-full md:w-96 border-[1px] border-gray-400 p-1 rounded-md outline-none m-1" />
                        <br />
                    ...
                    <div className='m-1'>
                        ...
                        <input id='location' value={state.location}  onChange={handleInput}  name='location' type="text" className='w-full border-[1px] border-gray-400 p-1 rounded-md outline-none m-1' placeholder='Location' required/>
                    ...
                    <div className='m-1'>
                        ...
                        <select id='generallocation'  value={state.generallocation} onChange={handleInput}  name='generallocation' className='w-full border-[1px] border-gray-400 p-1 rounded-md outline-none m-1' required>
                    ...
                    <div className='m-1'>
                        ...
                        <select id='statenews' value={state.statenews} onChange={handleInput}  name='statenews' className='w-full border-[1px] border-gray-400 p-1 rounded-md outline-none m-1' required>
